...
# 6. Number of Companies per Sector (Bar Chart)
...
# 7. Sector-wise Average EPS and Price (Side-by-side Bars)
...
# 9. Correlation Between Price and EPS
...
# 10. Scatter Plot: EPS vs. Price Colored by Sector
...
# 11. Create a New Column: Growth Category (based on P/E)
print("\n8. Growth Category")
...
# 12. Average P/E per Sector — Sorted Bar Plot
...
# 13. Boxplot of P/E Ratios by Sector
...
# 15. Save Enriched Dataset to New CSV
